...
import numpy as np
class model_cnn:
    def __init__(self, vec_len, text_len, w2v, learning_rate):
    ...
    def train_on_batch(self, sess, inputs_batch, labels_batch, dropout_rate):
    ...
    def add_prediction(self):
        ...
        max_drop = tf.nn.dropout(tf.squeeze(tf.concat(max,-1),name='features'),keep_prob=1-self.dropout_placeholder) #[None,100]
...
if __name__ == "__main__" :
    ...
    for epoch in range(100):
        for batch in range(100):
            ...
            M.train_on_batch(sess, inputs_batch, labels_batch,0.5)
